...
|---|---|---|
| [**CyberVault**](https://github.com/CyberNilsen/CyberVault) | Secure vault for managing passwords and other tools.<br> <br> • [CyberVault Website](https://github.com/CyberNilsen/CyberVault-website) Website for the program <br> <br> • [CyberVault Extension](https://github.com/CyberNilsen/CyberVault-Extension)  Google Extension for the program  | ![CyberVault Preview](https://github.com/user-attachments/assets/ad8568e6-56e0-4c2e-8e61-1d12526c7188) |
...
| [**USB Monitor**](https://github.com/CyberNilsen/USB-Monitor) | A Windows utility to monitor and control USB device connections.<br> Receive alerts, block/allow devices, and improve USB security. | ![USB Monitor](https://github.com/user-attachments/assets/9f9edcb2-98e2-4eeb-9c49-4249b210135f) |
| [**Remote Access Trojan (RAT)**](https://github.com/CyberNilsen/Remote-Access-Trojan) | Educational RAT project for learning about remote access and pentesting.<br> Demonstrates remote control, file transfer, and command execution. | ![RAT](https://github.com/user-attachments/assets/9c5068ea-d897-469e-983d-233aaefd8555) |
| [**Ransomware (Edu)**](https://github.com/CyberNilsen/Ransomware) | Project exploring ransomware behavior (strictly for educational purposes).<br> Investigate encryption, persistence, and mitigation techniques. | ![Ransomware](https://github.com/user-attachments/assets/d11d825f-a5ec-40d0-a28a-96716b100c57) |
| [**RoachBuddy**](https://github.com/CyberNilsen/RoachBuddy) | BonziBuddy-inspired desktop companion.<br> Fun, interactive character for your desktop with unique features. | ![RoachBuddy](https://github.com/user-attachments/assets/754b9243-5bb3-45b9-9810-a37531d1c5df) |
| [**Wifi Commands for Kali**](https://github.com/CyberNilsen/Wifi-Commands-Kali) | Simplified command helper for WiFi pentesting on Kali Linux.<br> Quick reference for wireless attacks and defenses. | ![Wifi Commands](https://github.com/user-attachments/assets/a056ea41-fb93-4da9-a8f1-b308a4be3c61) |
...
| [**School Project – PHP**](https://github.com/CyberNilsen/Oppdag-Norge-databasenettside) | A PHP project where I learned backend basics and login security.<br> Features authentication, SQL, and dynamic web content. | ![PHP Project](https://github.com/user-attachments/assets/1f09dc6a-66a8-4faf-9c22-139449258a9b) |
